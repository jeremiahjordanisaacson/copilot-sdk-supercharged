# GitHub Copilot SDK Cookbook - C

Short, practical recipes for using the GitHub Copilot SDK with C. Each recipe is concise, copy-pasteable, and production-ready.
