# GitHub Copilot SDK Cookbook - Lua

Short, practical recipes for using the GitHub Copilot SDK with Lua. Each recipe is concise, copy-pasteable, and production-ready.
