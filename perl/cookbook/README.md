# GitHub Copilot SDK Cookbook - Perl

Short, practical recipes for using the GitHub Copilot SDK with Perl. Each recipe is concise, copy-pasteable, and production-ready.
