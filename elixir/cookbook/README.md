# GitHub Copilot SDK Cookbook - Elixir

Short, practical recipes for using the GitHub Copilot SDK with Elixir. Each recipe is concise, copy-pasteable, and production-ready.
