# GitHub Copilot SDK Cookbook - Scala

Short, practical recipes for using the GitHub Copilot SDK with Scala. Each recipe is concise, copy-pasteable, and production-ready.
