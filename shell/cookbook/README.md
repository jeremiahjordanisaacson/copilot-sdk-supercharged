# GitHub Copilot SDK Cookbook - Shell/Bash

Short, practical recipes for using the GitHub Copilot SDK with Shell/Bash. Each recipe is concise, copy-pasteable, and production-ready.
