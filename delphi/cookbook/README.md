# GitHub Copilot SDK Cookbook - Delphi

Short, practical recipes for using the GitHub Copilot SDK with Delphi/Object Pascal. Each recipe is concise, copy-pasteable, and production-ready.
...
- [Advanced v2.0 Features](advanced-features.md): SessionFs, idle timeout, system prompts, skills, streaming, image generation, and more.
