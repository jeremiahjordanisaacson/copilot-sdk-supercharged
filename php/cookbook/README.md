# GitHub Copilot SDK Cookbook - PHP

Short, practical recipes for using the GitHub Copilot SDK with PHP. Each recipe is concise, copy-pasteable, and production-ready.
