# GitHub Copilot SDK Cookbook - Dart

Short, practical recipes for using the GitHub Copilot SDK with Dart. Each recipe is concise, copy-pasteable, and production-ready.
