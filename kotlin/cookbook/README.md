# GitHub Copilot SDK Cookbook - Kotlin

Short, practical recipes for using the GitHub Copilot SDK with Kotlin. Each recipe is concise, copy-pasteable, and production-ready.
