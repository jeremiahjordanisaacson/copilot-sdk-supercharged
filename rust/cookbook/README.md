# GitHub Copilot SDK Cookbook - Rust

Short, practical recipes for using the GitHub Copilot SDK with Rust. Each recipe is concise, copy-pasteable, and production-ready.
