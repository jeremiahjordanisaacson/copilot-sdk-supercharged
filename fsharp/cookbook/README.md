# GitHub Copilot SDK Cookbook - F#

Short, practical recipes for using the GitHub Copilot SDK with F#. Each recipe is concise, copy-pasteable, and production-ready.
...
- [Streaming Events](streaming-events.md): Subscribe to and process streaming events from the assistant.
- [Functional Patterns](functional-patterns.md): Idiomatic F# patterns including pipelines, computation expressions, and discriminated unions.
...
Add a new recipe by creating a markdown file in this folder and linking it above.
