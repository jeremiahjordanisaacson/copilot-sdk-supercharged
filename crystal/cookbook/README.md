# GitHub Copilot SDK Cookbook - Crystal

Short, practical recipes for using the GitHub Copilot SDK with Crystal. Each recipe is concise, copy-pasteable, and production-ready.
...
- [Fibers and Channels](fibers-and-channels.md): Concurrent patterns using Crystal fibers and channels.
