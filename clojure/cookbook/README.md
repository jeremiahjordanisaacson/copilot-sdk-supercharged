# GitHub Copilot SDK Cookbook - Clojure

Short, practical recipes for using the GitHub Copilot SDK with Clojure. Each recipe is concise, copy-pasteable, and production-ready.
