# GitHub Copilot SDK Cookbook - Nim

Short, practical recipes for using the GitHub Copilot SDK with Nim. Each recipe is concise, copy-pasteable, and production-ready.
