# GitHub Copilot SDK Cookbook - Ruby

Short, practical recipes for using the GitHub Copilot SDK with Ruby. Each recipe is concise, copy-pasteable, and production-ready.
