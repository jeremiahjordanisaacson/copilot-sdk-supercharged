# GitHub Copilot SDK Cookbook - Haskell

Short, practical recipes for using the GitHub Copilot SDK with Haskell. Each recipe is concise, copy-pasteable, and production-ready.
