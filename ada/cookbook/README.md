# GitHub Copilot SDK Cookbook - Ada

Short, practical recipes for using the GitHub Copilot SDK with Ada. Each recipe is concise, copy-pasteable, and production-ready.
...
- [Advanced v2.0 Features](advanced-features.md): Per-session auth, SessionFs, commands, system prompts, skills, config discovery, and more.
