# GitHub Copilot SDK Cookbook - Swift

Short, practical recipes for using the GitHub Copilot SDK with Swift. Each recipe is concise, copy-pasteable, and production-ready.
